...
end_time = datetime.strptime("2024-08-31 00:00:00", "%Y-%m-%d %H:%M:%S")
...
while current_time < end_time:
    ...
    requestBodyList.append({
        ...
        "queryDsl": f"update_time[Ge]={current_time.strftime('%Y-%m-%d %H:%M:%S')},update_time[Le]={next_time.strftime('%Y-%m-%d %H:%M:%S')},company_id[Eq]=167756765284235165"
    })
